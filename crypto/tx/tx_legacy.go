...
func (t *legacyTransaction) dependsOn() *common.Hash { return t.DependsOn }
...
func (t *legacyTransaction) evaluateWork(origin common.Address) func(nonce uint64) *big.Int {
